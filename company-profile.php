...
<html data-wf-domain="viss-first-project-7c06bd.webflow.io" data-wf-page="5af5e91622d5967921b52852" data-wf-site="5af5e91622d596fd7eb5284c" data-wf-status="1">
   <head>
      ...
      <style>
          ...
          .portfolio{
            font-family: 'Ubuntu Condensed',Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;
              font-size: 48px;
              font-weight: 10px;
              color:grey;
          }
    ...
    <div>
            <div class="card-item">
                    ...
                    <div style="width: 100%;margin: 10px;display: inline-block;">
                        <div style="width: 70%;border-right:1px solid black; padding: 0px 10px 10px 10px;display: inline-block">
                          ...
                          <div style="display: inline-block;">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3561.11982529573!2d75.806303!3d26.804313!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396dca20036cc459%3A0x9aa83e28dda36358!2sSkylark+Tech!5e0!3m2!1sen!2sin!4v1526681391603" width="300px" height="140px" frameborder="0" style="border:0" allowfullscreen></iframe>
                          </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <div style="width:100%;border-bottom: 1px solid black;display: inline-block;padding-bottom: 0px;padding: 0px;">
                        ...
                        <div style="display: inline-block;" class="header1" style="top: -50%">
                            <div style="display: inline-block;">
                                <ul>
                                    ...
                                    <li style="margin-left: 50px;display: inline-block;">
                                        <input type="button" id="bt1" name="bt1" value="Filter by" onclick="display()" style="width: 200px;;">
                                    </li>
                                    </ul>
                            </div>
                            ...
                            <div class="filt" >
                                <select>
                                    <option value="">Project Cost</option>
      ...
      <!--<div style="border-bottom: black;">
          <h1 class="first" style="text-align: center;">Top </h1>
      </div>
      <hr>
      <ul>
          <li style="display: inline-block;"><label>Sort By</label></li>
