   ...
   <?php require 'header.php'; ?>
    <div>
      <div style="border-bottom: black;">
          <h1 class="heading1" style="text-align: center;">Top AD company and Marketing Agencies</h1>
      </div>
      <hr>
      <ul>
      ...
      <div style="width: 100%;margin: 10px;">
          <div style="width: 75%;border-right:1px solid black; padding: 0px 10px 10px 10px;display: inline-block">
            ...
            <ul style="display: inline-block;">
                <li style="height: 50%;padding: 20px 20px 10px 50px;border-bottom: 1px solid silver" class="heading1"><a>Visit Website</a></li>
                <li  style="height: 50%;padding: 20px 20px 10px 50px;"  class="heading1"><a>View Profile</a></li>
            </ul>
      </div>
    </div>
