...
<html data-wf-domain="viss-first-project-7c06bd.webflow.io" data-wf-page="5af5e91622d5967921b52852" data-wf-site="5af5e91622d596fd7eb5284c" data-wf-status="1">
   ...
   <?php require 'header.php'; ?>
      ...
      <div class="container">
                        ...
                        <div class="row uniform">
                                <div class="12u$">
                                    ...
                                    <div class="select-wrapper">
                                        ...
                                        <option value="1">Advertisement and marketing</option>
                                        <option value="2">Automotive</option>
                                        <option value="3">Arts, music and entertainment</option>
          ...
          <div class="12u$" style="margin-left: 49%;">
                <ul class="actions">
      ...
      <script type="text/javascript">
        ...
        function add(){
            ...
            div.innerHTML= div.innerHTML + "<label for='market' id='valuemarket' >"+ value +"</label><input type='text' name='market' id='market' value='' placeholder=''/>";
        };
