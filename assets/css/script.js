...
! function(t) {
    ...
    window.tram = function(t) {
        ...
        function r(t) {
            ...
            return [e & gt; & gt;16 & 255, e & gt; & gt;8 & 255, 255 & e]
        }

        function o(t, e, n) {
            return "#" + (1 & lt; & lt; 24 | t & lt; & lt; 16 | e & lt; & lt; 8 | n).toString(16).slice(1)
        }
        ...
        function u(t, e, n) {
            ...
            var i = n;
            return V.test(t) || !J.test(t) ? i = parseInt(t, 10) : J.test(t) && (i = 1e3 * parseFloat(t)), 0 & gt;
            i && (i = 0), i == i ? i : n
        }
        ...
        var l = function(t, e, i) {
            ...
            f = {
                ...
                "ease-in-out-quart": ["cubic-bezier(0.770, 0, 0.175, 1)", function(t, e, n, i) {
                    return (t /= i / 2) & lt;
                    1 ? n / 2 * t * t * t * t + e : -n / 2 * ((t -= 2) * t * t * t - 2) + e
                }],
                ...
                "ease-in-out-quint": ["cubic-bezier(0.860, 0, 0.070, 1)", function(t, e, n, i) {
                    return (t /= i / 2) & lt;
                    1 ? n / 2 * t * t * t * t * t + e : n / 2 * ((t -= 2) * t * t * t * t + 2) + e
                }],
                ...
                "ease-in-out-expo": ["cubic-bezier(1, 0, 0, 1)", function(t, e, n, i) {
                    return 0 === t ? e : t === i ? e + n : (t /= i / 2) & lt;
                    1 ? n / 2 * Math.pow(2, 10 * (t - 1)) + e : n / 2 * (2 - Math.pow(2, -10 * --t)) + e
                }],
                ...
                "ease-in-out-circ": ["cubic-bezier(0.785, 0.135, 0.150, 0.860)", function(t, e, n, i) {
                    return (t /= i / 2) & lt;
                    1 ? -n / 2 * (Math.sqrt(1 - t * t) - 1) + e : n / 2 * (Math.sqrt(1 - (t -= 2) * t) + 1) + e
                }],
                ...
                "ease-in-out-back": ["cubic-bezier(0.680, -0.550, 0.265, 1.550)", function(t, e, n, i, r) {
                    return void 0 === r && (r = 1.70158), (t /= i / 2) & lt;
                    1 ? n / 2 * t * t * ((1 + (r *= 1.525)) * t - r) + e : n / 2 * ((t -= 2) * t * ((1 + (r *= 1.525)) * t + r) + 2) + e
                }]
            },
            d = {
            ...
            j = function(t) {
                ...
                var e, n, i = "",
                    r = t.split("-");
                for (e = 0; e & lt; r.length; e++) i += r[e].charAt(0).toUpperCase() + r[e].slice(1);
                for (e = 0; e & lt; M.length; e++)
        ...
        var I = e.frame = function() {
            ...
            D = l(function(e) {
                function r(t, e) {
                    var n = function(t) {
                            for (var e = -1, n = t ? t.length : 0, i = []; ++e & lt; n;) {
                                var r = t[e];
                                r && i.push(r)
                            }
                            return i
                ...
                function b(t, n) {
                    e[t] = function() {
                        return this.children ? function(t, e) {
                            ...
                            for (n = 0; i & gt; n; n++) t.apply(this.children[n], e);
                            return this
                ...
                e.init = function(e) {
                    ...
                    C.backface && B.hideBackface && U(this.el, C.backface.css, "hidden")
            ...
            H = l(function(e) {
                ...
                e.init = function(t) {
                    ...
                    var e, n, i;
                    this.active && (this.active = !1, e = this, (i = t.inArray(e, u)) & gt; = 0 && (n = u.slice(i + 1), u.length = i, n.length && (u = u.concat(n))))
                }, e.render = function(t) {
                    var e, n = t - this.start;
                    if (this.delay) {
                        if (n & lt; = this.delay) return;
                        n -= this.delay
                    }
                    if (n & lt; this.duration) {
            ...
            P = l(H, function(t) {
                t.init = function(t) {
                    ...
                    t - this.start & lt;
                    this.duration || (this.complete.call(this.context), this.destroy())
                }
            }),
            W = l(H, function(t, e) {
                t.init = function(t) {
    ...
    n(4), n(6), n(8), n(10), n(11), n(12), n(13), t.exports = n(14)
}, function(t, e, n) {
    var i = n(0);
    ...
    t.exports = function() {
        var t = {
            ...
            p = (o.bind, t.each = t.forEach = function(n, i, r) {
                ...
                if (u && n.forEach === u) n.forEach(i, r);
                    ...
                    for (var o = 0, a = n.length; o & lt; a; o++)
                        if (i.call(r, n[o], o, n) === e) return
                } else {
                    var s = t.keys(n);
                    for (o = 0, a = s.length; o & lt; a; o++)
        ...
        t.contains = t.include = function(t, e) {
            ...
            var r, o, a, s, u, c = function c() {
                var l = t.now() - s;
                l & lt;
                n ? r = setTimeout(c, n - l) : (r = null, i || (u = e.apply(a, o), a = o = null))
            };
            return function() {
            ...
            for (var n = 1, i = arguments.length; n & lt; i; n++) {
                var r = arguments[n];
    ...
    r.triggers = {}, r.types = {
        ...
        for (var t = o.length, e = 0; e & lt; t; e++) {
            var n = o[e];
            n[0](0, n[1])
        }
    ...
    i.define("forms", t.exports = function(t, e) {
        ...
        function k(e) {
            ...
            if (y(e), a) {
                ...
                l && s.indexOf("https://webflow.com") & gt; = 0 && (s = s.replace("https://webflow.com", "http://formdata.webflow.com")), t.ajax({
                    url: s,
                    type: "POST",
                    data: r,
                    dataType: "json",
    ...
    i.define("links", t.exports = function(t, e) {
        ...
        function m() {
            ...
            e.each(r, function(e) {
                var i = e.link,
                    ...
                    a = r.outerHeight(),
                    s = .5 * n,
                    u = r.is(":visible") && o + a - s & gt; = t && o + s & lt; = t + n;
        ...
        return a.ready = a.design = a.preview = function() {
            ...
            for (var t = document.links, e = 0; e & lt; t.length; ++e) v(t[e]);
    ...
    i.define("navbar", t.exports = function(t, e) {
        ...
        function j(t, e) {
            if (t.open) {
                ...
                var n = t.config;
                if (("none" === n.animation || !u.support.transform || n.duration & lt; = 0) && (e = !0), g.outro(0, t.el[0]), l.off("tap" + h, t.outside), e) return u(t.menu).stop(), void c();
                        ...
                        ! function(e, i) {
                            ...
                            if ("mid" === e.data("scroll")) {
                                var a = t(n).height() - i,
                                    s = e.outerHeight();
                                s & lt;
                                a && (o -= Math.round((a - s) / 2))
                            }
                            var u = 1;
                            t("body").add(e).each(function() {
                                var e = parseFloat(t(this).attr("data-scroll-time"), 10);
                                !isNaN(e) && (0 === e || e & gt; 0) && (u = e)
                            ...
                            ! function t() {
                                ...
                                n.scroll(0, function(t, e, n, i) {
                                    if (n & gt; i) return e;
                                    return t + (e - t) * (r = n / i, r & lt; .5 ? 4 * r * r * r : (r - 1) * (2 * r - 2) * (2 * r - 2) + 1);
                                    var r
                                }(r, o, e, f)), e & lt; = f && l(t)
                            }()
                        }(u, f)
    ...
    i.define("slider", t.exports = function(t, e) {
        ...
        function O(e, n) {
            ...
            var a = n.index,
                u = {};
            a & lt;
            0 ? (a = r.length - 1, i.infinite && (u.x = -e.endX, u.from = 0, u.to = r[0].width)) : a & gt; = r.length && (a = 0, i.infinite && (u.x = r[r.length - 1].width, u.from = -r[r.length - 1].x, u.to = u.from - u.x)), e.index = a;
            ...
            var f = e.offsetX || 0,
                ...
                x = n.vector || (e.index & gt; e.previous ? 1 : -1),
                k = "opacity " + y + "ms " + b,
                _ = "transform " + y + "ms " + b;
        ...
        function z(e) {
            ...
            0 && (u = 0), e.anchors = [{
                ...
                r && (r = parseFloat(r) + "px");
                for (var o = 0; o & lt; e.pages; o++) n = t(h), e.nav.hasClass("w-num") && n.text(o + 1), null != r && n.css({
                    "margin-left": r,
                    "margin-right": r
                }), i.push(n);
        ...
        return n && (t.event.special.tap = {
            ...
            return n ? null : (e = "string" == typeof e ? t(e).get(0) : e) ? new function(t) {
                ...
                function l(t) {
                    var i = t.touches;
                    i && i.length & gt;
                    1 || (a = !0, s = !1, i ? (u = !0, e = i[0].clientX, n = i[0].clientY) : (e = t.clientX, n = t.clientY), o = e)
                }
                ...
                function f(t) {
                    if (a) {
                        ...
                        var l = t.touches,
                            ...
                            p = f - o;
                        o = f, Math.abs(p) & gt;
                        c && i && "" === String(i()) && (r("swipe", t, {
                            direction: p & gt;0 ? "right" : "left"
                        }), h()), (Math.abs(f - e) & gt; 10 || Math.abs(d - n) & gt; 10) && (s = !0)
                    }
                }
